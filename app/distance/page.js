 ...
 * Date: 2024-10-09
 *
 * DistanceConverterPage Component
 * This page component renders the DistanceConverter and Navbar components.
...
export default function DistanceConverterPage() {
  return (
    ...
    >
      ...
      <Navbar />
      {/* Container for the DistanceConverter centered on the page */}
      <div className="flex flex-col items-center justify-center min-h-screen bg-opacity-70 bg-gray-900 text-white">
        {/* DistanceConverter component that will handle the conversion logic */}
        <DistanceConverter />
      </div>
    </div>
  );
